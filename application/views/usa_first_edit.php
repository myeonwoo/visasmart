...
<section id="main" class="container"> <!-- 1152 pixels Container -->
	...
	<div class="twelve columns" id="pContent">
		...
		<section id="page-content" class="clearfix"> <!-- inner grid 720 pixels wide -->
			<textarea id="board_content" name="contents" style="width:950px;height:500px;"><?php echo $contents; ?></textarea>
			<br />
...
<script type='text/javascript'>
	...
	$(function() {
		...
		$('#update_content').click(function()
		{
			...
			var url = local_site.site_url + 'api/manager/update_notice_board/format/json';

			var data = {};
			data['contents'] = $('#board_content').val();
			...
			$.ajax({
				...
				success: function(content){
					console.log(content);
					url = local_site.site_url + 'admin/manager/notice_board_edit';

					// nid 는 api 로 부터 받을값으로 대체
					nid = content['nid'];
					url += '/app/' + app + '/type/' + type + '/nid/' + nid;
