...
<head>
	...
	<title>Tectonic | Single Project: YouTube Video</title>
						...
						<li><a href="portfolio-2-columns.html" class="current">Portfolio</a>
							<ul>
								...
								<li><a href="single-project-video-youtube.html" class="current">Project with Video</a>
									<ul>
										<li><a href="single-project-video-youtube.html" class="current">YouTube Video</a></li>
	...
	<div class="four columns five-item-menu" id="iBoard" data-smallscreen="yes">
		...
		<div class="five columns alpha omega">
			<aside id="info-board" class="shadow" data-smallscreen="yes">
				<h5>Overview</h5>
				<p>This example of a single project page contains video embedded from <a href="http://youtube.com" target="_blank" title="YouTube site">YouTube</a>. The attributes listed below (<em>Category</em>, <em>Privacy</em>, <em>Date</em>) can be modified, of course. You can add additional ones, remove existing or add another few...</p>
				<div class="small-bar colored"></div>
				<ul class="data">
					<li><strong>Category:</strong> Science & Technology</li>
					<li><strong>Privacy:</strong> Public</li>
					<li><strong>Date:</strong> May 2006</li>
				</ul>
	...
	<div class="twelve columns" id="pContent">
		...
		<section id="page-content" class="clearfix"> <!-- inner grid 720 pixels wide -->
			...
			<div class="twelve columns">
				...
				<!-- Video -->
				<div class="video-container margin-bottom-35px">
					<iframe width="700" height="393" class="frame-scale-with-grid" src="http://www.youtube.com/embed/Qd9z48Bo8ZA?wmode=transparent&amp;rel=0&amp;showinfo=0" frameborder="0" allowfullscreen></iframe>
				</div>
		...
		<aside id="sidebar">
			...
			<div class="widget" data-smallscreen="yes"> <!-- show widget on a small-screen mobile device: "yes" or "no" -->
				...
				<ul class="categories square-list">
					...
					<li class="current"><a href="single-project-video-youtube.html">Google Custom Search</a></li>
