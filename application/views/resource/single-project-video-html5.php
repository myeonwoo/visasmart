...
<head>
	...
	<title>Tectonic | Single Project: HTML5 Video</title>
					...
					<ul id="main-menu">
						...
						<li><a href="portfolio-2-columns.html" class="current">Portfolio</a>
							<ul>
								...
								<li><a href="single-project-video-youtube.html" class="current">Project with Video</a>
									<ul>
										<li><a href="single-project-video-youtube.html">YouTube Video</a></li>
										<li><a href="single-project-video-vimeo.html">Vimeo Video</a></li>
										<li><a href="single-project-video-html5.html" class="current">HTML5 Video</a></li>
									</ul>
								</li>
							</ul>
						</li>
	...
	<div class="four columns five-item-menu" id="iBoard" data-smallscreen="yes">
		...
		<div class="menu shadow" data-smallscreen="yes">
			<ul id="secondary-menu">
				...
				<li class="current"><a href="#"><h6 class="title">Planning</h6></a></li>
		...
		<div class="five columns alpha omega">
			<aside id="info-board" class="shadow" data-smallscreen="yes">
				<h5>Overview</h5>
				<p>This is an example of a single project page with HTML5 Video. The attributes listed below (<em>Production Time</em>, <em>Author</em>, <em>Software</em>) can be modified, of course. You can add additional ones, remove existing or add another few...</p>
				<div class="small-bar colored"></div>
				<ul class="data">
					<li><strong>Production Time:</strong> 5 months</li>
					<li><strong>Author:</strong> Chris Burton</li>
					<li><strong>Software:</strong> Blender 2.5 Alpha 0</li>
				</ul>
				<a href="#" class="link-sm uppercase">View Website<span></span></a>
			</aside>
		</div>
	</div>
	...
	<div class="twelve columns" id="pContent">
		...
		<section id="page-content" class="clearfix"> <!-- inner grid 720 pixels wide -->
			...
			<div class="twelve columns">
				...
				<!-- Video -->
				<div class="html5-video-container margin-bottom-35px" data-aspect-ratio="1.77778"><!-- video aspect ratio - 16/9 -->
					<video class="player" poster="images/portfolio/project7-poster.jpg" controls>
		...
		<aside id="sidebar">
			...
			<div class="widget" data-smallscreen="yes"> <!-- show widget on a small-screen mobile device: "yes" or "no" -->
				...
				<ul class="categories square-list">
					...
					<li class="current"><a href="single-project-video-html5.html">Taste Lab</a></li>
...
<script src="<?php echo base_url(); ?>static/js/html5media.min.js"></script> <!-- Cross-browser solution for embedding HTML5 video -->
