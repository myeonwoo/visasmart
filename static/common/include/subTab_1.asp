	  ...
	  <% if gubun="1" and board_use = "1" then %> 
    <ul class="Tab_Area c_box">
	        <li><a href="qna.asp?gubun=1&board_use=1" onfocus="blur()"><img src="/common/images/visa/visa_tab01_00_on.gif" alt="전체" name="Faq_tab_img1" class="block" id="Faq_tab_img1" /></a></li>
			<li><a href="qna.asp?gubun=1&board_use=1" onfocus="blur()"><img src="/common/images/visa/visa_tab01_01_a.gif" class="block" alt="Q &amp; A" /></a></li>
			<li><a href="qna.asp?gubun=1&board_use=2" onfocus="blur()"><img src="/common/images/visa/visa_tab01_02.gif" class="block" alt="비자후기" /></a></li>
	  </ul>
	<% if gubun="1" and board_use = "1" then %> 
    <ul class="Tab_Area c_box">
            <li><a href="qna.asp?gubun=1&board_use=1" onfocus="blur()"><img src="/common/images/visa/visa_tab01_00.gif" alt="전체" name="Faq_tab_img1" class="block" id="Faq_tab_img1" /></a></li>
			<li><a href="qna.asp?gubun=1&board_use=1" onfocus="blur()"><img src="/common/images/visa/visa_tab01_01_on.gif" class="block" alt="Q &amp; A" /></a></li>
			<li><a href="qna.asp?gubun=1&board_use=2" onfocus="blur()"><img src="/common/images/visa/visa_tab01_02.gif" class="block" alt="비자후기" /></a></li>
	  </ul>
    <% elseif gubun="1" and board_use = "2" then %>
    <ul class="Tab_Area c_box">
	        <li><a href="qna.asp?gubun=1&board_use=1" onfocus="blur()"><img src="/common/images/visa/visa_tab02_01.gif" alt="전체" name="Faq_tab_img1" class="block" id="Faq_tab_img1" /></a></li>
			<li><a href="qna.asp?gubun=1&board_use=1" onfocus="blur()"><img src="/common/images/visa/visa_tab01_01.gif" class="block" alt="Q &amp; A" /></a></li>
			<li><a href="qna.asp?gubun=1&board_use=2" onfocus="blur()"><img src="/common/images/visa/visa_tab01_02_on.gif" class="block" alt="비자후기" /></a></li>
	  </ul>
